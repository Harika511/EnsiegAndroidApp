...
public class MyCalendarActivity extends Activity implements OnClickListener {
	...
	private Button selectedDayMonthYearButton, btOk, btCancel;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btOk = (Button) findViewById(R.id.bt_ok_calender);
		btOk.setOnClickListener(this);
		btCancel = (Button) findViewById(R.id.bt_cancel_calender);
	...
	public class GridCellAdapter extends BaseAdapter implements OnClickListener {
		...
		private final String[] months = { "Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sep", "Oct", "Nov",
				"Dec" };
		private final String[] months_number = { "1", "2", "3", "4", "5", "6", "7", "Aug", "Sep", "Oct", "Nov", "Dec" };
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			String monthInfo = "";
			if (presentMonth < 10) {
				monthInfo = "0" + presentMonth;
			} else {
				monthInfo = presentMonth + "";
			}
			...
			gridcell.setTag(theyear + "-" + monthInfo + "-" + theday);
			// Toast.makeText(getApplicationContext(), theyear + "-" + themonth
			// + "-" + theday + " date ",
