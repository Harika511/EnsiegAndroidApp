...
public class Ensieg_MatchCenter extends Activity {
	String selectedTeam = "";
	Context mContext;
	ImageView iv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		EnsiegDB register = new EnsiegDB(Ensieg_MatchCenter.this);
		...
		if (getIntent() != null) {
			...
			if (value != null) {
				...
				te = value.get(7);
				Log.d("", "team id in matcch " + team1_Id + " " + team2_Id + " " + te);
			...
			} else if (invited != null && invited.equals("invite")) {
	...
	public void initializeViews() {
		...
		ivMessage.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent chat = new Intent(Ensieg_MatchCenter.this, Ensieg_ChatActivity.class);
		...
		ivShare.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent in = new Intent(Ensieg_MatchCenter.this, Ensieg_TeamGroupsActivity.class);
	...
	private class GetMatchData extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... urls) {
			...
			if (invited != null) {
				if (invited.equals("invite")) {
					nameValuePairs.add(new BasicNameValuePair("eventidfk", invitedEventId));
					nameValuePairs.add(new BasicNameValuePair("teamid-1", invitedTeam1));
					nameValuePairs.add(new BasicNameValuePair("teamid-2", invitedTeam2));
				}
			} else {
				nameValuePairs.add(new BasicNameValuePair("eventidfk", event_id));
